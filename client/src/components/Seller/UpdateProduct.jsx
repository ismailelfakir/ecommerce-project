    ...
    <div className="bg-[#fff] ">
      {product ? (
        <div className="fixed w-full h-screen top-0 left-0 bg-[#00000030] z-40 flex items-center justify-center">
          <div className="w-[90%] 800px:w-[60%] h-[90vh] overflow-y-scroll 800px:h-[75vh] dark:bg-gray-700  bg-white rounded-md shadow-sm relative p-4">
            <RxCross1
              size={30}
            ...
            <form onSubmit={handleUpdate}>
              ...
              <div>
                ...
                <input
                  ...
                  name="name"
                  value={name}
                  className="mt-2 appearance-none block w-full px-3 h-[35px] border dark:bg-gray-600 dark:border-gray-500 dark:text-white border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  name="description"
                  value={description}
                  className="mt-2  dark:text-whiteappearance-none block w-full pt-2 px-3 border dark:bg-gray-600 border-gray-300 rounded-[3px] dark:border-gray-500 placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              ...
              <div>
                ...
                <select
                  className="w-full mt-2 border h-[35px] rounded-[5px] dark:bg-gray-600 dark:border-gray-500"
                  value={category}
                  onChange={(e) => setCategory(e.target.value)}
                >
                  <option value="Choose a category dark:bg-gray-600 dark:border-gray-500">Choose a category</option>
                  {categoriesData &&
              ...
              <br />
              <div>
                <label className="pb-2 dark:text-white">Tags</label>
                <input
                  type="text"
                  name="tags"
                  value={tags}
                  className="mt-2 appearance-none block w-full px-3 h-[35px] bg-gray-50 dark:bg-gray-600 border dark:border-gray-500 border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              ...
              <br />
              <div>
                <label className="pb-2 dark:text-white">Original Price</label>
                <input
                  type="number"
                  name="price"
                  value={originalPrice}
              ...
              <div>
                ...
                <div className="w-full flex items-center flex-wrap">
                  <label htmlFor="upload">
                    <AiOutlinePlusCircle
                      size={30}
                      className="mt-3 text-gray-700 dark:text-white"
                ...
                <div>
                  <input
                    type="submit"
                    value="Update"
                    className="mt-2 cursor-pointer appearance-none text-center block w-full px-3 h-[35px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-gray-700 text-white hover:bg-gray-500 dark:bg-gray-500 dark:hover:text-white dark:hover:bg-gray-700"
                  />
                </div>
              </div>
            </form>
